...
The *I. ricinus* reference genome assembly was used to generate the genomic regions used for downstream analyses. Repetitive regions were removed using the annotation file ([Link](https://bipaa.genouest.org/sp/ixodes_ricinus/download/ixodes_ricinus/assembly_1.0/track_Repeated_elements__RepeatMasker__2023-11-24_/track_file/)) published with the assembly reference genome ([Cerqueira de Araujo et al., 2025](https://doi.org/10.1186/s12915-025-02121-1)) and low-mappability regions were identified using GenMap v1.3.0 ([Pockrandt et al., 2020](https://doi.org/10.1093/bioinformatics/btaa222)). GenMap was run using a k-mer length of 150 bp and an edit distance of 2, and regions with a mappability score ≥1 were retained.

A final BED file was generated by intersecting the reference genome with regions showing good mappability and excluding repetitive regions. This BED file was then restricted to the 13 main scaffolds (putative sex chromosome 12 excluded) to define the autosomal regions used in downstream analyses. ANGSD-compatible regions files were subsequently generated and indexed.
